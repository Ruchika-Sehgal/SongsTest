...
//functionality 1: create a slider that produces images of the same size
let bhaktiS = [
    { "img": "url(./images/bhakti/ganesha.jpeg)", "song": "url(./songs/Bhakti/DevaShreeGanesha.mp3)" },
    { "img": "url(./images/bhakti/RamNaMilenge.jpeg)", "song": "url(./songs/Bhakti/RamNaMilenge.mp3)" },
    { "img": "url(./images/bhakti/mangal_bhavan.jpg)", "song": "url(./songs/Bhakti/mangalBhawan.mp3)" },
    { "img": "url(./images/bhakti/Sai.jpeg)", "song": "./songs/Bhakti/Sai.mp3)" },
    { "img": "url(./images/bhakti/shriKrishna.jpeg)", "song": "url(./songs/Bhakti/ShriKrishnaGovindHareMurari.mp3)" },
]
let currentIndex = 4;
